...
const Appui = ({ app }: AppuiProps) => {
  ...
  useEffect(() => {
    setPostUrl(`${process.env.NEXT_PUBLIC_API_URL}/application/${app._id}`);
  }, [app._id]);
  ...
  const showNavigation = app.connectionpost.length > 0;
  ...
  return (
    <main className="mt-4">
      <div className="w-auto rounded-xl p-2 flex flex-col gap-4 bg-header shadow-gray-600 shadow-md">
        <Suspense>
